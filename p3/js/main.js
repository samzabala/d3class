...
var svg = d3.select('#chart-area').append('svg')
    ...
    var g = svg.append('g')
    .attr('transform','translate('+def.margin * 3 +','+def.margin+')')
    // X Label
        xLab = g.append("text")
...
function update(dat){
    ...
    //set up graph graphic
        ...
        // bar.transition(def.duration)
        //     .attr('width',x.bandwidth)
        //     .attr('height',(dis,i) => { 
        //         return def.height - y(dis[value])
        //     })
        //     .attr('x',(dis,i)=>{
        //         return x(dis.month)
        //     })
        ...
        bar
            ...
            .attr('height',0)
            .attr('y',y(0))
            .merge(bar) //use same calls for update from here so less repitir
            .transition(def.duration)
                .attr('x',(dis,i)=>{
                    return x(dis.month)
                })
